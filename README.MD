...
|   | Before 2.3 | 2.3 |
| --- | --- | --- |
| 显示开屏广告 | startSplashAD(Activity activity,SplashADEventListener splashADEventListener) | public void playSplashAD(final Activity activity, SplashADEventListener listener) |
